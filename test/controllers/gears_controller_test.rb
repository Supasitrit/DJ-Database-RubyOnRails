...
class GearsControllerTest < ActionController::TestCase
  ...
  test "should create gear" do
    assert_difference('Gear.count') do
      post :create, gear: { description: @gear.description, dj_id: @gear.dj_id, geartype_id: @gear.geartype_id, name: @gear.name }
    end
  ...
  test "should update gear" do
    patch :update, id: @gear, gear: { description: @gear.description, dj_id: @gear.dj_id, geartype_id: @gear.geartype_id, name: @gear.name }
    assert_redirected_to gear_path(assigns(:gear))
  end
